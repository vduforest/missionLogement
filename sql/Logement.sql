...
CREATE SEQUENCE public.alerte_alerte_id_seq START
WITH
...
CREATE SEQUENCE public.config_modif_modif_id_seq START
WITH
    1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
CREATE SEQUENCE public.connexion_connexion_id_seq START
WITH
    1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
CREATE SEQUENCE public.date_date_id_seq START
WITH
    1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
CREATE SEQUENCE public.formulaire_formulaire_id_seq START
WITH
    1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
CREATE SEQUENCE public.genre_genre_id_seq START
WITH
    1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
CREATE TABLE public.mission_logement_status (
    ...
    CONSTRAINT mission_logement_status_status_check CHECK (
...
CREATE SEQUENCE public.mission_logement_status_id_seq AS integer START
WITH
    1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
CREATE SEQUENCE public.pays_pays_id_seq START
WITH
    1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
CREATE SEQUENCE public.personne_personne_id_seq START
WITH
    1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
CREATE SEQUENCE public.role_role_id_seq START
WITH
    1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
CREATE SEQUENCE public.souhait_souhait_id_seq START
WITH
    1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
CREATE SEQUENCE public.statut_statut_id_seq START
WITH
    1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
CREATE SEQUENCE public.type_appart_type_appart_id_seq START
WITH
    1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
CREATE SEQUENCE public.type_modif_type_id_seq START
WITH
    1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
ALTER COLUMN alerte_id
SET DEFAULT nextval(
    'public.alerte_alerte_id_seq'::regclass
);
...
ALTER COLUMN modif_id
SET DEFAULT nextval(
    'public.config_modif_modif_id_seq'::regclass
);
...
ALTER COLUMN connexion_id
SET DEFAULT nextval(
    'public.connexion_connexion_id_seq'::regclass
);
...
SET DEFAULT nextval(
    'public.date_date_id_seq'::regclass
);
...
ALTER COLUMN formulaire_id
SET DEFAULT nextval(
    'public.formulaire_formulaire_id_seq'::regclass
);
...
SET DEFAULT nextval(
    'public.genre_genre_id_seq'::regclass
);
...
ALTER COLUMN id
SET DEFAULT nextval(
    'public.mission_logement_status_id_seq'::regclass
);
...
ALTER COLUMN pays_id
SET DEFAULT nextval(
    'public.pays_pays_id_seq'::regclass
);
...
SET DEFAULT nextval(
    'public.personne_personne_id_seq'::regclass
);
...
SET DEFAULT nextval(
    'public.role_role_id_seq'::regclass
);
...
ALTER COLUMN souhait_id
SET DEFAULT nextval(
    'public.souhait_souhait_id_seq'::regclass
);
...
SET DEFAULT nextval(
    'public.statut_statut_id_seq'::regclass
);
...
ALTER COLUMN type_appart_id
SET DEFAULT nextval(
    'public.type_appart_type_appart_id_seq'::regclass
);
...
SET DEFAULT nextval(
    'public.type_modif_type_id_seq'::regclass
);
...
INSERT INTO
    public.config_modif (modif_id, type_id, contenu)
VALUES (
        3,
        3,
...
VALUES (
        7,
        6,
        'message mission fermée'
    );

INSERT INTO
    public.config_modif (modif_id, type_id, contenu)
VALUES (8, 7, 'message 1er contact');
...
VALUES (
        31,
        3,
        'Vous savez moi je pense pas qu''il y ait de bonnes ou de mauvaises situations.'
    );

INSERT INTO
    public.config_modif (modif_id, type_id, contenu)
VALUES (2, 1, '2025-01-30T09:00');

INSERT INTO
    public.config_modif (modif_id, type_id, contenu)
VALUES (4, 2, '2025-02-28T21:00');
...
VALUES (
        32,
        4,
        'Je pense que la vie c''est avant tout des rencontres'
    );
...
VALUES (
        33,
        5,
        'Si je devais dire quelque chose aux personnes qui m''ont tendu la main par le passé'
    );
...
VALUES (
        34,
        6,
        'Ce serait merci à la vie, oui merci'
    );

INSERT INTO
    public.config_modif (modif_id, type_id, contenu)
VALUES (9, 8, 'mailcontact@gmail.com');
...
VALUES (
        35,
        3,
        'Bienvenue sur la plateforme mission logement'
    );
...
VALUES (
        36,
        4,
        'Numéro de la mission logement : '
    );

INSERT INTO
    public.config_modif (modif_id, type_id, contenu)
VALUES (37, 6, 'Mission fermée');
...
VALUES (
        38,
        3,
        'Bienvenue sur la plateforme mission logement et informations'
    );
...
VALUES (
        39,
        4,
        'Informations sur la mission logement'
    );
...
VALUES (
        40,
        5,
        'Avant mission (inutile pour le moment)'
    );

INSERT INTO
    public.config_modif (modif_id, type_id, contenu)
VALUES (19, 7, 'message 2eme contact');

INSERT INTO
    public.config_modif (modif_id, type_id, contenu)
VALUES (20, 7, 'message 3eme contact');

INSERT INTO
    public.config_modif (modif_id, type_id, contenu)
VALUES (21, 7, 'message 1er contact');

INSERT INTO
    public.config_modif (modif_id, type_id, contenu)
VALUES (22, 1, '2025-02-02T09:00');

INSERT INTO
    public.config_modif (modif_id, type_id, contenu)
VALUES (23, 2, '2025-02-28T20:00');
...
VALUES (
        26,
        5,
        'message page d''attente la mission logement est actuellement fermée'
    );
...
INSERT INTO
    public.config_modif (modif_id, type_id, contenu)
VALUES (41, 1, '2025-07-30T10:00');

INSERT INTO
    public.config_modif (modif_id, type_id, contenu)
VALUES (42, 2, '2025-07-31T14:00');
...
VALUES (
        43,
        8,
        'mission.logement@ec-nantes.frail.com'
    );
...
VALUES (
        45,
        3,
        'Bienvenu.e sur la plateforme de la mission logement !
...
VALUES (
        115,
        5,
        '<h2>Bienvenu.e sur la plateforme de la mission logement ! </h2>
...
VALUES (
        103,
        9,
        '<h1>Bienvenu.e sur la plateforme de la mission logement ! </h1>
...
VALUES (
        134,
        4,
        '<h2>Informations pratiques de la plateforme Mission logement ! </h2>
...
VALUES (
        '125bcb18-f1f2-4a33-bb01-1939986cd876',
        '2025-10-02 12:47:40.417',
        2
    );
...
INSERT INTO
    public.mission_logement_status (id, status)
VALUES (1, 2);
...
INSERT INTO
    public.pays (pays_id, pays_nom)
VALUES (2, 'Afghanistan');

INSERT INTO
    public.pays (pays_id, pays_nom)
VALUES (3, 'Afrique du sud');
...
INSERT INTO
    public.pays (pays_id, pays_nom)
VALUES (18, 'Corée du Sud');

INSERT INTO
    public.pays (pays_id, pays_nom)
VALUES (19, 'Costa Rica');
...
INSERT INTO
    public.pays (pays_id, pays_nom)
VALUES (23, 'Emirats arabes unis');

INSERT INTO public.pays (pays_id, pays_nom) VALUES (24, 'Equateur');

INSERT INTO
    public.pays (pays_id, pays_nom)
VALUES (25, 'Etats-Unis');

INSERT INTO
    public.pays (pays_id, pays_nom)
VALUES (26, 'El Salvador');
...
INSERT INTO
    public.pays (pays_id, pays_nom)
VALUES (70, 'Antarctique');

INSERT INTO
    public.pays (pays_id, pays_nom)
VALUES (71, 'Antigua et Barbuda');
...
INSERT INTO
    public.pays (pays_id, pays_nom)
VALUES (77, 'Bangladesh');

INSERT INTO
    public.pays (pays_id, pays_nom)
VALUES (78, 'Biélorussie');
...
INSERT INTO
    public.pays (pays_id, pays_nom)
VALUES (101, 'Rép. Dém. du Congo');

INSERT INTO
    public.pays (pays_id, pays_nom)
VALUES (102, 'Iles Cook');
...
INSERT INTO
    public.pays (pays_id, pays_nom)
VALUES (106, 'Dominique');

INSERT INTO
    public.pays (pays_id, pays_nom)
VALUES (107, 'République Dominicaine');

INSERT INTO public.pays (pays_id, pays_nom) VALUES (108, 'Timor');

INSERT INTO
    public.pays (pays_id, pays_nom)
VALUES (109, 'Guinée Equatoriale');
...
INSERT INTO
    public.pays (pays_id, pays_nom)
VALUES (113, 'Ile Falkland');

INSERT INTO
    public.pays (pays_id, pays_nom)
VALUES (114, 'Iles Féroé');

INSERT INTO public.pays (pays_id, pays_nom) VALUES (115, 'Fidji');

INSERT INTO
    public.pays (pays_id, pays_nom)
VALUES (116, 'Guyane française');

INSERT INTO
    public.pays (pays_id, pays_nom)
VALUES (117, 'Polynésie française');
...
INSERT INTO
    public.pays (pays_id, pays_nom)
VALUES (133, 'Iles Heard et McDonald');
...
INSERT INTO
    public.pays (pays_id, pays_nom)
VALUES (151, 'Liechtenstein');

INSERT INTO
    public.pays (pays_id, pays_nom)
VALUES (152, 'Lithuanie');

INSERT INTO
    public.pays (pays_id, pays_nom)
VALUES (153, 'Luxembourg');

INSERT INTO public.pays (pays_id, pays_nom) VALUES (154, 'Macau');

INSERT INTO
    public.pays (pays_id, pays_nom)
VALUES (155, 'Macédoine du Nord');

INSERT INTO
    public.pays (pays_id, pays_nom)
VALUES (156, 'Madagascar');
...
INSERT INTO
    public.pays (pays_id, pays_nom)
VALUES (161, 'Iles Marshall');

INSERT INTO
    public.pays (pays_id, pays_nom)
VALUES (162, 'Martinique');

INSERT INTO
    public.pays (pays_id, pays_nom)
VALUES (163, 'Mauritanie');
...
INSERT INTO
    public.pays (pays_id, pays_nom)
VALUES (170, 'Montserrat');

INSERT INTO
    public.pays (pays_id, pays_nom)
VALUES (171, 'Mozambique');
...
INSERT INTO
    public.pays (pays_id, pays_nom)
VALUES (176, 'Antilles néerlandaises');

INSERT INTO
    public.pays (pays_id, pays_nom)
VALUES (177, 'Nouvelle Calédonie');

INSERT INTO
    public.pays (pays_id, pays_nom)
VALUES (178, 'Nicaragua');
...
INSERT INTO
    public.pays (pays_id, pays_nom)
VALUES (182, 'Iles Norfolk');

INSERT INTO
    public.pays (pays_id, pays_nom)
VALUES (183, 'Iles Mariannes du Nord');
...
INSERT INTO
    public.pays (pays_id, pays_nom)
VALUES (194, 'Saint-Kitts et Nevis');

INSERT INTO
    public.pays (pays_id, pays_nom)
VALUES (195, 'Sainte Lucie');
...
INSERT INTO
    public.pays (pays_id, pays_nom)
VALUES (198, 'Saint-Marin');

INSERT INTO
    public.pays (pays_id, pays_nom)
VALUES (199, 'Sao Tomé-et-Principe');

INSERT INTO public.pays (pays_id, pays_nom) VALUES (200, 'Sénégal');

INSERT INTO
    public.pays (pays_id, pays_nom)
VALUES (201, 'Seychelles');

INSERT INTO
    public.pays (pays_id, pays_nom)
VALUES (202, 'Sierra Leone');

INSERT INTO
    public.pays (pays_id, pays_nom)
VALUES (203, 'Slovaquie');
...
INSERT INTO
    public.pays (pays_id, pays_nom)
VALUES (206, 'Sri Lanka');

INSERT INTO
    public.pays (pays_id, pays_nom)
VALUES (207, 'Sainte Hélène');
...
INSERT INTO
    public.pays (pays_id, pays_nom)
VALUES (220, 'Trinité et Tobago');

INSERT INTO public.pays (pays_id, pays_nom) VALUES (221, 'Tunisie');

INSERT INTO
    public.pays (pays_id, pays_nom)
VALUES (222, 'Turkménistan');

INSERT INTO
    public.pays (pays_id, pays_nom)
VALUES (223, 'Iles Turks et Caïques');
...
INSERT INTO
    public.pays (pays_id, pays_nom)
VALUES (232, 'Iles Vierges');

INSERT INTO
    public.pays (pays_id, pays_nom)
VALUES (233, 'Wallis et Futuna');
...
INSERT INTO
    public.pays (pays_id, pays_nom)
VALUES (238, 'La Barbad');

INSERT INTO
    public.pays (pays_id, pays_nom)
VALUES (166, 'Micronésie');
...
VALUES (
        ...
        'Alice',
        'admin',
        '$2a$15$DjmRqv2N0PE7bHpAJWSTz.5VvxjJtrg0kIpeQfDQDmw/BiIk1RAdu',
        2,
        NULL,
        NULL
    );
...
VALUES (
        ...
        'JYM',
        'JYM',
        '$2a$15$70bCEAl4FT37ZosLlPKdoOfvrZSq57aSGfrOjoUrKQoy06s9EEtqG',
        2,
        NULL,
        NULL
    );
...
VALUES (
        ...
        'Emilie',
        'EmilieVE',
        '$2a$15$Xj4LJRSK.J6WHQ8EWvR1duj/VF/xBy.w7OMSlkN3qXoAx2HblVsrS',
        3,
        NULL,
        NULL
    );
...
INSERT INTO
    public.statut (statut_id, statut_nom)
VALUES (1, 'Non traitée');
...
INSERT INTO
    public.type_modif (type_id, nom)
VALUES (3, 'message_pge_connexion');

INSERT INTO
    public.type_modif (type_id, nom)
VALUES (
        4,
        'message_page_informations'
    );

INSERT INTO
    public.type_modif (type_id, nom)
VALUES (5, 'message_page_attente');

INSERT INTO
    public.type_modif (type_id, nom)
VALUES (6, 'message_mission_fermee');

INSERT INTO
    public.type_modif (type_id, nom)
VALUES (8, 'adresse_mail_envoyeur');

INSERT INTO
    public.type_modif (type_id, nom)
VALUES (7, 'message_contact');

INSERT INTO
    public.type_modif (type_id, nom)
VALUES (9, 'message_avant_connexion');
...
SELECT pg_catalog.setval (
        'public.config_modif_modif_id_seq', 157, true
    );
...
SELECT pg_catalog.setval (
        'public.connexion_connexion_id_seq', 3, true
    );
...
SELECT pg_catalog.setval (
        'public.formulaire_formulaire_id_seq', 1557, true
    );
...
SELECT pg_catalog.setval (
        'public.mission_logement_status_id_seq', 1, false
    );
...
SELECT pg_catalog.setval (
        'public.personne_personne_id_seq', 1613, true
    );
...
SELECT pg_catalog.setval (
        'public.type_appart_type_appart_id_seq', 3, true
    );
