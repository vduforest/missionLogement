...
<head>
  <title>Réinitialisation du mot de passe - Mission Logement</title>
  <meta charset="UTF-8" />
        ...
        <div class="login-box">
          <form action="submitpasswordreset.do" method="POST" onsubmit="return showLoading()">
            ...
            <div class="form-group">
              ...
              <input type="text" id="mySCEI" name="scei" placeholder="Votre numéro SCEI" class="form-control custom-input" required />
            </div>

            <div class="form-group">
              <label for="myMail">Adresse e-mail</label>
              <input type="email" id="myMail" name="mail" placeholder="Votre adresse mail" class="form-control custom-input" required />
            </div>
    ...
    <div class="split-pane right-pane">
      <div class="content-wrapper text-content">
        <div class="info-text">
            ...
            <p>
                Pour réinitialiser votre mot de passe, veuillez saisir votre <strong>numéro SCEI</strong> ainsi que l'<strong>adresse e-mail</strong> 
                associée à votre dossier de candidature.
            </p>
            <p>
                Un e-mail contenant un lien de réinitialisation vous sera envoyé. Ce lien sera valide pendant <strong>24 heures</strong>.
            </p>
            <p>
                Si vous ne recevez pas l'e-mail dans les prochaines minutes, vérifiez votre dossier de courriers indésirables (spams).
            </p>
        </div>
      </div>
    </div>
