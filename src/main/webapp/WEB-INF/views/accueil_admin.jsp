            ...
            <div class="d-flex align-items-center justify-content-between w-100">
              ...
              <div class="d-flex align-items-center">
                <button class="p-0 ml-3 bg-transparent border-0"
                        formaction="adminDashboard.do"
                        style="display:flex; align-items:center;">
                  <img src="img/logocn.png" alt="logo" class="logo"/>
                </button>
              </div>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="table-responsive">
                ...
                <c:choose>
                  <c:when test="${succes}">
                    <div class="export" style="border-color: green"><p style="color:green">Les formulaires ont été importés avec succès</p></div>
                  </c:when>
                  <c:when test="${erreur}">
                    <div class="export" style="border-color: red"><p style="color:red">Les formulaires n'ont pas pu être importés</p></div>
                  </c:when>
                  <c:when test="${suppressionSuccess}">
                    <div class="export" style="border-color: green"><p style="color:green">Les données on été supprimées avec succès</p></div>
                  </c:when>
                  <c:when test="${suppressionErreur}">
                    <div class="export" style="border-color: red"><p style="color:red">Erreur lors de la suppression des données</p></div>
                  </c:when>
                  <c:otherwise/>
                </c:choose>
