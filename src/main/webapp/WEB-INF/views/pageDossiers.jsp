      ...
      <div class="row mb-2 align-items-end">
        <div class="col-md-12 d-flex justify-content-between align-items-center">
          ...
          <form method="post" action="dossiers.do" class="m-0">
            ...
            <button class="refresh-btn" title="Rafra√Æchir">
                ...
                <c:forEach var="formulaire" items="${forms}">
                  <tr>
                    ...
                    <td class="text-center">
                      ...
                      <c:if test="${(! empty formulaire.estPmr) && (formulaire.estPmr)}">NÈcessite amÈnagement<br />
                      </c:if>
                      ...
                      <c:if test="${(empty formulaire.genreId)}"><span class="text-danger">Genre non indiquÈ</span><br /></c:if>
                      <c:if test="${(empty formulaire.mail)}"><span class="text-danger">Adresse mail non indiquÈ</span><br /></c:if>
                      <c:if test="${(empty formulaire.numeroTel)}"><span class="text-danger">NumÈro de tÈlÈphone non indiquÈ</span><br /></c:if>
                      ...
                      <c:if test="${(empty formulaire.souhaitId)}"><span class="text-danger">Souhait non formulÈ</span><br /></c:if>
            ...
            <div class="row mb-2 align-items-end">
              <div class="col-md-12 d-flex justify-content-between align-items-center">
                ...
                <form method="post" action="dossiers.do" class="m-0">
                  <input type="hidden" name="connexionId" value="${connexionId}" />
                  <button class="refresh-btn" title="Rafra√Æchir">
                    <img src="img/refresh.png" alt="Refresh" class="refresh-icon" /> Rafra√Æchir
                  </button>
                </form>
              </div>
            </div>
                      ...
                      <c:forEach var="formulaire" items="${forms}">
                        <tr>
                          ...
                          <td class="text-center">
                            ...
                            <c:if test="${(! empty formulaire.estPmr) && (formulaire.estPmr)}">N√©cessite
                              am√©nagement<br />
                            </c:if>
                              ...
                              <div class="col-md-6">
                                <form action="AnnulerPwd2.do" id="check_${formulaire.formulaireId}" method="POST">
                                  ...
                                  <button name="reinitialiser" class="btn btn-danger"
                                    onclick="return checkSubmit('check_${formulaire.formulaireId}', 'R√©initialiser le mot de passe ?');">
        ...
        <script type="text/javascript">
          $(document).ready(function () {
            ...
            $('#etatFilterDropdown').on('click', function (e) {
              e.stopPropagation(); // Emp√™che la fermeture quand on clique sur un label
            });

            // Trigger quand on coche/d√©coche
