                  ...
                  <c:forEach var="formulaire" items="${forms}">
                    <tr>
                      ...
                      <td class="text-center">
                        ...
                        <c:if test="${(! empty formulaire.estPmr) && (formulaire.estPmr)}">N�cessite am�nagement<br/></c:if>
                        ...
                        <td class="text-center">
                          ...
                          <div class="col-md-6">
                            <form action="AnnulerPwd2.do" id="check_${formulaire.formulaireId}" method="POST">
                              ...
                              <button name="reinitialiser" class="btn btn-danger" onclick="return checkSubmit('check_${formulaire.formulaireId}', 'R�initialiser le mot de passe ?');">
