                        ...
                        <div class="row mb-2 align-items-end">
                            <div class="col-md-12 d-flex justify-content-between align-items-center">
                                ...
                                <div class="d-flex" style="gap: 10px;">
                                    <form method="post" action="nouveauDossier.do" class="m-0">
                                    ...
                                    <form method="post" action="dossiers.do" class="m-0">
                                        ...
                                        <button class="refresh-btn" title="Rafraîchir"
                                            onclick="this.disabled=true; this.innerHTML='<img src=\'img/refresh.png\' class=\'refresh-icon spin\' /> Chargement...'; this.form.submit();">
                                            ...
                                            <tr>
                                                ...
                                                <th scope="col" class="text-center">Etat
                                                    <div style="display:inline-block;position:relative;">
                                                        <button id="etatFilterBtn" type="button" class="btn btn-sm"
                                                            style="margin-left:6px;padding:2px 6px;">---</button>
                                                        <div id="etatFilterDropdown"
                                                            style="display:none;position:absolute;right:0;background:#fff;border:1px solid #ccc;padding:8px;z-index:1000;min-width:140px;">
                                                            <label><input type="checkbox" class="etat-checkbox"
                                                                    value="traite_complet" checked /> Traitement
                                                                complet</label><br />
                                                            <label><input type="checkbox" class="etat-checkbox"
                                                                    value="dossier_non_conforme" checked /> Dossier non
                                                                conforme</label><br />
                                                            <label><input type="checkbox" class="etat-checkbox"
                                                                    value="a_traiter" checked /> A traiter</label><br />
                                                            <label><input type="checkbox" class="etat-checkbox"
                                                                    value="non_transmis" checked /> Non transmis</label>
                                                        </div>
                                                    </div>
                                                </th>
