                      ...
                      <form method="post" id="formVe">
                          ...
                          <table class="table table-striped">
                            <tbody>
                              <tr>
                                <th scope="col">Nom</th>
                                <td>
                                  <input type="text" id="nom" name="nom" value="${form.personneId.nom}"
                                    disabled="disabled" />
                                </td>
                                <td>
                              ...
                              <tr>
                                ...
                                <td>
                                  <input type="text" id="prenom" name="prenom" value="${form.personneId.prenom}"
                                    disabled="disabled" />
                                </td>
                                <td>
                              ...
                              <tr>
                                ...
                                <td>
                                  <input type="text" id="ville" name="ville" value="${form.ville}"
                                    disabled="disabled" />
                                </td>
                                <td>
                              ...
                              <tr>
                                ...
                                <td>
                                  <input type="text" id="codePostal" name="codePostal" value="${form.codePostal}"
                                    disabled="disabled" />
                                </td>
                                <td>
                                  ...
                                  <select id='pays' name="pays" disabled='disabled'>
                                    <c:forEach var="pays" items="${pays}">
                                      <option value=${pays.paysId}
                                        ${form.paysId.paysId==pays.paysId?'selected="selected"' : ''}>${pays.paysNom}</option>
                                </c:forEach>
                              </select>
                            </td>
                            <td>
                              ...
                              <tr>
                                ...
                                <td>
                                  <input type="text" id="mail" name="mail" value="${form.mail}"
                              ...
                              <tr>
                                <th scope="col" style="color:red">Commentaire Mission Logement<br />(sera transmis à
                                  l'étudiant en cas de refus du dossier)</th>
                                <td>
                                  <textarea class="commentairesVe" cols="40" rows="5" name="commentairesVe"
                                    id="commentairesVe" style="color:red"
                                    disabled="disabled">${form.commentairesVe}</textarea>
                                </td>
                                <td>
                        ...
                        <div class="container mt-4 mb-4 text-center">
                          <div class="row justify-content-center">
                            <div class="col-md-6">
                              <p>Le Bouton Vider et Transmettre gardera toutes les informations présentes sur cet écran
