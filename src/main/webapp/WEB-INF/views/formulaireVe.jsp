                                        ...
                                        <div class="table-responsive">
                                            <c:choose>
                                                <c:when test="${item.estConforme}">
                                                    <p style="color:red">Le formulaire à déjà été validé</p>
                                                </c:when>
                                                <c:when test="${(!item.estValide) && (! empty item.commentairesVe)}">
                                                    <p style="color:blue">Le formulaire a été refusé mais peut être
                                                        corrigé</p>
                                                </c:when>
                                            </c:choose>
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-striped">
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td class="text-center align-middle">
                                                                    <button type="button" id="locker_nom"
                                                                        ...
                                                                        <img id="img_nom" src="img/close.png"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-center align-middle">
                                                                    <button type="button" id="locker_prenom"
                                                                        ...
                                                                        style="gap: 5px; margin:auto; width: 140px;">
                                                                        <img id="img_prenom" src="img/close.png"
                                                                            class="avion" alt="Verrouillé" />
                                                            ...
                                                            <tr>
                                                                <th scope="col"><label for="dateNaissance">Date de
                                                                        Naissance(XX/MM/YYYY)</label>)</th>
                                                                <td>
                                                                    <fmt:formatDate value="${item.dateDeNaissance}"
                                                                        pattern="dd/MM/yyyy" var="formattedDate" />
                                                                    <input type="text" id="dateNaissance"
                                                                        name="dateDeNaissance" class="dateNaissance"
                                                                ...
                                                                <td class="text-center align-middle">
                                                                    <button type="button" id="locker_dateNaissance"
                                                                        ...
                                                                        <img id="img_dateNaissance" src="img/close.png"
                                                                            class="avion" alt="Verrouillé" />
                                                                        <span
                                                                            id="text_locker_dateNaissance">Verrouillé</span>
                                                                    </button>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <input type="text" id="ville" name="ville"
                                                                        value="${item.ville}" disabled="disabled"
                                                                        required="required" />
                                                                </td>
                                                                <td class="text-center align-middle">
                                                                    <button type="button" id="locker_ville"
                                                                        ...
                                                                        style="gap: 5px; margin:auto; width: 140px;">
                                                                        <img id="img_ville" src="img/close.png"
                                                                            class="avion" alt="Verrouillé" />
                                                            ...
                                                            <tr>
                                                                <th scope="col"><label for="codePostal">Code
                                                                        Postal</label></th>
                                                                <td>
                                                                ...
                                                                <td class="text-center align-middle">
                                                                    <button type="button" id="locker_codePostal"
                                                                        ...
                                                                        style="gap: 5px; margin:auto; width: 140px;">
                                                                        <img id="img_codePostal" src="img/close.png"
                                                                            class="avion" alt="Verrouillé" />
                                                                        <span
                                                                            id="text_locker_codePostal">Verrouillé</span>
                                                                    </button>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <th scope="col" <c:if
                                                                    test="${(empty item.paysId) || (item.paysId.paysId != 1)}">
                                                                    style="background-color:orange"</c:if>>Pays</th>
                                                                <td>
                                                        ...
                                                        <td class="text-center align-middle">
                                                            <button type="button" id="locker_pays" class="btn btn-outline-dark btn-sm d-flex align-items-center justify-content-center"
                                                                    onclick="delock(' pays')"
                                                                                style="gap: 5px; margin:auto; width: 140px;">
                                                                                <img id="img_pays" src="img/close.png"
                                                                                    class="avion" alt="Verrouillé" />
                                                                                <span
                                                                                    id="text_locker_pays">Verrouillé</span>
                                                                                </button>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td class="text-center align-middle">
                                                                    <button type="button" id="locker_mail"
                                                                        ...
                                                                        onclick="delock('mail')"
                                                                        style="gap: 5px; margin:auto; width: 140px;">
                                                                        <img id="img_mail" src="img/close.png"
                                                                            class="avion" alt="Verrouillé" />
                                                            ...
                                                            <tr>
                                                                    ...
                                                                    <select id="Genre" name="Genre" disabled="disabled"
                                                                        ...
                                                                        <c:forEach var="genre" items="${genresList}">
                                                                            <option value="${genre.genreId}" ${(! empty
                                                                                ...
                                                                                ? 'selected="selected"' : '' }
                                                                                readonly="readonly">${genre.genreNom}
                                                                            </option>
                                                                        </c:forEach>
                                                                    </select>
                                                                    <br />
                                                                ...
                                                                <td class="text-center align-middle">
                                                                    <button type="button" id="locker_Genre"
                                                                        ...
                                                                        style="gap: 5px; margin:auto; width: 140px;">
                                                                        <img id="img_Genre" src="img/close.png"
                                                                            class="avion" alt="Verrouillé" />
                                                            ...
                                                            <tr>
                                                                <th scope="col"><label for="tel">Numéro de
                                                                        téléphone</label></th>
                                                                <td>
                                                                    <input id="tel" type="text" name="tel"
                                                                        value="${item.numeroTel}" disabled="disabled"
                                                                        required="required" />
                                                                </td>
                                                                <td class="text-center align-middle">
                                                                    <button type="button" id="locker_tel"
                                                                        ...
                                                                        onclick="delock('tel')"
                                                                        style="gap: 5px; margin:auto; width: 140px;">
                                                                        <img id="img_tel" src="img/close.png"
                                                                            class="avion" alt="Verrouillé" />
                                                            ...
                                                            <tr>
                                                                <th scope="col"><label for="tel2">Deuxième numéro de
                                                                        téléphone</label></th>
                                                                <td>
                                                                    <input id="tel2" type="text" name="tel2"
                                                                        value="${item.tel2}" disabled="disabled" />
                                                                </td>
                                                                <td class="text-center align-middle">
                                                                    <button type="button" id="locker_tel2"
                                                                        ...
                                                                        onclick="delock('tel2')"
                                                                        style="gap: 5px; margin:auto; width: 140px;">
                                                                        <img id="img_tel2" src="img/close.png"
                                                                            class="avion" alt="Verrouillé" />
                                                            ...
                                                            <tr>
                                                                <th scope="col" <c:choose>
                                                                    ...
                                                                    <c:when
                                                                        test="${(! empty item.estBoursier) && (item.estBoursier)}">
                                                                        style="background-color:orange"</c:when>
                                                                    </c:choose>>Êtes-vous boursier ?
                                                                </th>
                                                                <td>
                                                                    <select name="boursier" id="boursier"
                                                                        disabled="disabled" required="required">
                                                                        <c:if test="${(empty item.estBoursier)}">
                                                                            <option value="null" ${empty
                                                                                item.estBoursier ? 'selected="selected"'
                                                                                : '' }>---
                                                                            </option>
                                                                        </c:if>
                                                                    ...
                                                                    <c:choose>
                                                                        ...
                                                                        <c:when test="${item.estBoursier}">
                                                                            <button formaction="telechargerBourse.do"
                                                                                type="submit" id="telechargement"
                                                                ...
                                                                <td class="text-center align-middle">
                                                                    <button type="button" id="locker_boursier"
                                                                        ...
                                                                        style="gap: 5px; margin:auto; width: 140px;">
                                                                        <img id="img_boursier" src="img/close.png"
                                                                            class="avion" alt="Verrouillé" />
                                                                        <span
                                                                            id="text_locker_boursier">Verrouillé</span>
                                                                    </button>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <th scope="col"><label for="souhait">Préférence
                                                                        logement</label></th>
                                                                <td>
                                                                    <select id="souhait" name="Souhait" <c:if
                                                                        ...
                                                                        <option value=0 ${(empty item.souhaitId) ||
                                                                            (item.souhaitId.souhaitId <=0)
                                                                            ? 'selected="selected"' : '' }
                                                                            readonly="readonly">
                                                                            ------------------------------------------------
                                                                        </option>
                                                                        <c:forEach var="souhait"
                                                                            items="${souhaitsList}">
                                                                            <option value="${souhait.souhaitId}" ${(!
                                                                                empty item.souhaitId) &&
                                                                ...
                                                                <td class="text-center align-middle">
                                                                    <button type="button" id="locker_souhait"
                                                                        ...
                                                                        style="gap: 5px; margin:auto; width: 140px;">
                                                                        <img id="img_souhait" src="img/close.png"
                                                                            class="avion" alt="Verrouillé" />
                                                            ...
                                                            <tr>
                                                                <th scope="col"><label for="pmr">Avez-vous besoin de
                                                                ...
                                                                <td class="text-center align-middle">
                                                                    <button type="button" id="locker_pmr"
                                                                        ...
                                                                        onclick="delock('pmr')"
                                                                        style="gap: 5px; margin:auto; width: 140px;">
                                                                        <img id="img_pmr" src="img/close.png"
                                                                            class="avion" alt="Verrouillé" />
                                                                        <span id="text_locker_pmr">Verrouillé</span>
                                                                    </button>
                                                                </td>
                                                            <tr>
                                                                <th scope="col" style="color:blue"><label
                                                                        for="comEleve">Commentaire Eleve</label></th>
                                                                <td class="infoSupplementaires" id="comEleve"
                                                                    name="infoSupplementaires" style="color:blue">
                                                                ...
                                                                <td class="text-center align-middle">
                                                                    <button type="button" id="locker_commentairesVe"
                                                                        ...
                                                                        <img id="img_commentairesVe" src="img/close.png"
                                                                            class="avion" alt="Verrouillé" />
                                                                        <span
                                                                            id="text_locker_commentairesVe">Verrouillé</span>
                                                                    </button>
                                                                </td>
                                                            </tr>
                                                            <tr
                                                                    ...
                                                                    <span
                                                                        ...
                                                                        <c:choose>
                                                                            <c:when test="${not empty item.assistant}">
                                                                                ...
                                                                                <strong>${item.assistant.prenom}
                                                                                    ${item.assistant.nom}</strong>
                                                                            </c:when>
                                                                            <c:otherwise>
                                                                ...
                                                                <td>
                                                                    <label for="commentairesInternes"> commentaires
                                                                        internes</label>
                                                                ...
                                                                <td class="text-center align-middle">
                                                                    <button type="button"
                                                                        id="locker_commentairesInternes"
                                                                        class="btn btn-outline-dark btn-sm d-flex align-items-center justify-content-center"
                                                                        onclick="delock('commentairesInternes')"
                                                                        style="gap: 5px; margin:auto; width: 140px;">
                                                                        <img id="img_commentairesInternes"
                                                                            src="img/close.png" class="avion"
                                                                            alt="Verrouillé" />
                                                                        <span
                                                            ...
                                                            <c:choose>
                                                                <c:when test="${item.estConforme}">
                                                                    ...
                                                                    <c:if test="${!empty item.lastTraitement}">
                                                                        <p>Validé par
                                                                            ${item.lastTraitement.personneId.prenom}
                                                                    ...
                                                                    <c:if
                                                                        ...
                                                                        <p>Validé par ${item.assistant.prenom}
                                                                            ${item.assistant.nom}</p>
                                                                    </c:if>
                                                                    <c:if
                                                                        test="${(! empty connexion) && (connexion.isAdmin())}">
                                                                        <button onclick="openForm('formVe')"
                                                                            formaction="EnregistrerFormVe.do"
                                                                ...
                                                                <c:otherwise>
                                                                    <button onclick="openForm('formVe')"
                                                                        ...
                                                                        name="annulerpwd" class="btn btn-info"
                                                                        value="annulerpwd" <c:if
                                                                        test="${empty item.personneId.password}">disabled="disabled"
                                                                        </c:if>>
                                                                        Reinitialiser Mot de Passe <img
                                                                            src="img/refuse.png" class="icon"
                                                                            alt="Reinitialiser" />
                                                                    </button>
                                                                    ...
                                                                    <button onclick="openForm('formVe')"
                                                                        ...
                                                                        value="enregistrer">
                                                                        Sauvegarder <img src="img/save.png" class="icon"
                                                                            alt="save" />
                                                                    </button>

                                                                    <button onclick="openForm('formVe')"
                                                                        formaction="ValiderFormVe.do" type="submit"
                                                                        name="valider" class="btn btn-success mr-3"
                                                                        value="valider">
