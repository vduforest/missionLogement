                                ...
                                <div class="table-responsive">
                                    <c:choose>
                                        ...
                                        <c:when test="${(!item.estValide) && (! empty item.commentairesVe)}">
                                            <p style="color:blue">Le formulaire a été refusé mais peut être corrigé</p>
                                        </c:when>
                                    </c:choose>
                                            ...
                                            <table class="table table-striped">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <button type="button" id="locker_nom" class="btn btn-secondary"
                                                                    onclick="delock('nom')">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <button type="button" id="locker_prenom" class="btn btn-secondary"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <button type="button" id="locker_ville" class="btn btn-secondary"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <button type="button" id="locker_codePostal" class="btn btn-secondary"
                                                    ...
                                                    <tr>
                                                        <th scope="col" <c:if test="${(empty item.paysId) || (item.paysId.paysId != 1)}">
                                              ...
                                              pays')">
                                                    ...
                                                    <tr style="background-color: #f8f9fa; border-top: 2px solid #dee2e6;">
                                                        ...
                                                        <td>
                                                            <button type="button" id="locker_commentairesInternes" class="btn btn-outline-success"
                                                                    onclick="delock('commentairesInternes')">
                                                                <img id="img_commentairesInternes" src="img/close.png" class="avion" alt="Modifier" />
                                                            </button>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            ...
                                            <div class="row justify-content-center">
                                                <div class="col-md-10">
                                                    ...
                                                    <c:choose>
                                                        ...
                                                        <c:otherwise>
                                                            <button onclick="openForm('formVe')" formaction="AnnulerPwd.do" type="submit"
                                                                    name="annulerpwd" class="btn btn-info" value="annulerpwd" <c:if
                                                                        test="${empty item.personneId.password}">disabled="disabled"</c:if>>
                                                                        Reinitialiser Mot de Passe <img src="img/refuse.png" class="icon"
                                                                                                        alt="Reinitialiser" />
                                                                    </button>
                                                                    ...
                                                                    <button onclick="openForm('formVe')" formaction="ValiderFormVe.do" type="submit"
                                                                            name="valider" class="btn btn-success mr-3" value="valider">
