                                                ...
                                                <select id="souhait" name="Souhait" <c:if
                                                        ...
                                                        <c:forEach var="souhait" items="${souhaitsList}">
                                                            <option value="${souhait.souhaitId}" ${(! empty
                                                                             ...
                                                                             ? 'selected="selected"' : '' }
                                                                    readonly="readonly">${souhait.souhaitType}
                                                            </option>
                                                        </c:forEach>
                                                </select>
                                            </div>
                                    ...
                                    <div class="modern-form-table">
                                        ...
                                        <div class="form-row">
                                            <div class="label-col"><label
                                                    for="distance">Distance</label></div>
                                            <div class="input-col">
                                        ...
                                        <div class="form-row">
                                            <div class="label-col">
                                                ...
                                                <span
                                                    ...
                                                    <c:choose>
                                                        <c:when
                                                            test="${not empty item.traitementCollection}">
                                            ...
                                            <c:choose>
                                                <c:when test="${item.estConforme}">
                                                    ...
                                                    <c:if test="${!empty item.lastTraitement}">
                                                        <p>Validé par
                                                            ${item.lastTraitement.personneId.prenom.toUpperCase()} ${item.lastTraitement.personneId.nom.toUpperCase()}
                                                            le
                                                            <fmt:formatDate
                                                ...
                                                <c:otherwise>
                                                    ...
                                                    <button onclick="return confirmerEtOuvrir('formVe', 2)"
                                                            ...
                                                            value="enregistrer">
                                                        Sauvegarder 
                                                        <img src="img/save.png" class="icon"
                                                             alt="save" />
                                                    </button>

                                                    <button onclick="return confirmerEtOuvrir('formVe', 3)"
                                                            formaction="ValiderFormVe.do"
                                                            type="submit" name="valider" class="btn btn-success mr-2"
                                                            value="valider">
                                                        Valider 
                                                    ...
                                                    <button onclick="return confirmerEtOuvrir('formVe', 4)" 
                                                            formaction="RefuserFormVe.do" 
                                                            type="submit" name="refuser" class="btn btn-danger"
                                                            value="refuser" >
                                                        ...
                                                        <div class="col-md-10">
                                                            ...
                                                            <c:choose>
                                                                <c:when test="${item.estConforme}">
                                                                    ...
                                                                    <c:if test="${!empty item.lastTraitement}">
                                                                        <p>Validé par
                                                                            ${item.lastTraitement.personneId.prenom.substring(0,1).toUpperCase()}${item.lastTraitement.personneId.nom.substring(0,1).toUpperCase()}
                                                                            le
                                                                            <fmt:formatDate
                                                                                value="${item.lastTraitement.dateTraitement}"
                                                                                pattern="dd/MM/yyyy HH:mm" />
...
>>>>>>> 3cf53830a5fea18d9a93ed55b6f29ebee91f862f-->
