...
<body>
    ...
    <div class="main-container">
        <div class="info-card" style="position: relative;">
            ...
            <form method="post" action="configuration.do" style="position: absolute; top: 20px; right: 20px; z-index: 10;">
            ...
            <div class="status-highlight">
                Statut actuel : <strong>${missionStatus == 0 ? 'Avant mission' : (missionStatus == 1 ? 'Mission en cours' : 'Mission fermée')}</strong>
            </div>
                        ...
                        <div class="input-col">
                            <div class="button-group">
                                <button type="submit" class="Enregistrer">
                                    Mettre à jour les dates <img src="img/save.png" class="icon" />
                                </button>
                                <button type="button" 
                                    <c:if test="${missionStatus != 2}">disabled="disabled"</c:if> 
                                    onclick="return checkSubmit('configuration', 'supprimerDonnees.do', '!!Attention!! \n Voulez-vous vraiment supprimer ces données ?\n Cette action est irréversible');" 
...
M.;Durand;Lucas;15/06/2002;75015;Paris;France;84532;lucas.durand@eleves.ec-nantes.fr</pre>
                ...
                <form id="importForm" action="importEleves.do" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="text-center mb-4">
                        <button type="button" class="Import" onclick="document.getElementById('fichierImport').click();">
            ...
            <form action="saveConfig.do" method="POST" id="configuration">
                ...
                <div class="modern-form-table">
                    <div class="form-row">
                        ...
                        <div class="input-col">
                            <input type="text" name="adresse_mail_envoyeur" class="mail_envoyeur" value="${adresse_mail_envoyeur}" />
                        </div>
                    </div>
                        ...
                        <div class="input-col">
                            ...
                            <div class="button-group">
                                <button type="submit" class="EnvoiMails" formaction="envoiemailfin.do" 
                                    <c:if test="${missionStatus != 2}">disabled="disabled" title="Disponible uniquement quand la 'Mission est fermée'"</c:if>>
                    ...
                    <div class="form-row">
                        ...
                        <div class="input-col">
                            <textarea name="message_dossier_incomplet">${message_dossier_incomplet}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="input-col">
                            <textarea name="message_dossier_complet">${message_dossier_complet}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="modern-form-table">
                    <div class="form-row">
                        ...
                        <div class="input-col">
                            <textarea name="message_avant_connexion">${message_avant_connexion}</textarea>
                        </div>
                    </div>
                    <div class="form-row">
                    ...
                    <div class="form-row">
                        ...
                        <div class="input-col">
                            <textarea name="message_page_informations">${message_page_informations}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="modern-form-table">
                    <div class="form-row">
                        ...
                        <div class="input-col">
                            ...
                            <div>
                                ...
                                <input type="text" name="tooltip_date_naissance" value="${tooltip_date_naissance}" />
                            </div>
                        </div>
                    </div>
                    <div class="form-row">
                        ...
                        <div class="input-col">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="tooltip_code_postal" value="${tooltip_code_postal}" />
                            </div>
                            <div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="input-col">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="tooltip_confirm_mail" value="${tooltip_confirm_mail}" />
                            </div>
                            <div class="mb-3">
                    ...
                    <div class="form-row">
                        ...
                        <div class="input-col">
                            ...
                            <div>
                                <label class="field-label">Infobulle Informations Complémentaires</label>
                ...
                <div class="form-actions text-center">
                    <button type="submit" class="Enregistrer" style="padding: 15px 60px; font-size: 1.1rem;">
