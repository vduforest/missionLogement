            ...
            <div class="d-flex align-items-center justify-content-between w-100">
              ...
              <div class="d-flex align-items-center">
                ...
                <button class="p-0 ml-3 bg-transparent border-0"
                  formaction="${not empty homeLink ? homeLink : ((not empty connexion && connexion.isAdmin()) ? 'adminDashboard.do' : ((not empty connexion && connexion.isAssistant()) ? 'dossiers.do' : 'informations.do'))}"
